...
![](https://github.com/pmukneam/twitter_postgres_parallel/workflows/tests_normalized/badge.svg)

![](https://github.com/pmukneam/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg)

![](https://github.com/pmukneam/twitter_postgres_parallel/workflows/tests_normalized_batch/badge.svg)

![](https://github.com/pmukneam/twitter_postgres_parallel/workflows/tests_normalized_batch_parallel/badge.svg)

![](https://github.com/pmukneam/twitter_postgres_parallel/workflows/tests_denormalized/badge.svg)

![](https://github.com/pmukneam/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg)
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_denormalized`      |         `0m18.781s`       |         `0m4.139s`        | 
| `pg_normalized`        |         `7m46.794s`       |         `1m2.217s`        | 
| `pg_normalized_batch`  |         `2m46.499s`       |         `0m15.229s`       | 
